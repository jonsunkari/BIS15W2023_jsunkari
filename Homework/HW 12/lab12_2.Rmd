...
ui <- dashboardPage(
  dashboardHeader(title = "Composition of Wolf Packs"),
  dashboardSidebar(disable=T),
  dashboardBody(
    fluidRow(
      box(title="Plot Options", width = 3,
          radioButtons("x", "Select Wolf Population", choices=c("AK.PEN", "BAN.JAS", "BC", "DENALI", "ELLES", "GTNP", "INT.AK", "MEXICAN", "MI", "MT", "N.NWT", "ONT", "SE.AK", "SNF", "SS.NWT", "YNP", "YUCH"),
                      selected="AK.PEN"),
          ),
       box(title = "Plot of Wolf Data", width = 7,
  plotOutput("plot", width = "600px", height = "500px")
       )
    )
  )
